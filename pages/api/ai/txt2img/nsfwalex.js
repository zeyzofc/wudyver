...
class Animagine {
  ...
  async request() {
    ...
    const config = {
      method: "POST",
      url: "https://nsfwalex-realism-pony-card.hf.space/queue/join?__theme=system",
      headers: {
  ...
  cekStatus() {
    return new Promise((resolve, reject) => {
      const eventSource = new EventSource("https://nsfwalex-realism-pony-card.hf.space/queue/data?session_hash=" + this.session_hash);
