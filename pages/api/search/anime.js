...
class Meganei {
  constructor() {
    this.BASE_URL = `https://${apiConfig.DOMAIN_URL}/api/tools/web/html/v8?url=https://meganei.net`;
  }
  async search(query) {
    try {
...
class NeoNime {
  search = async (query, page = 1) => {
    return new Promise(async (resolve, reject) => {
      try {
        const {
          data
        } = await axios.get(`https://${apiConfig.DOMAIN_URL}/api/tools/web/html/v8?url=https://neonime.ink/page/${page}/?s=${query}`);
  ...
  ongoing = async (page = 1) => {
    return new Promise(resolve => {
      if (!page) page = 1, axios.get(`https://${apiConfig.DOMAIN_URL}/api/tools/web/html/v8?url=https://neonime.cloud/episode/page/${page}/`).then(({
        data
      }) => {
        const $ = cheerio.load(data);
        const result = [];
...
class Anoboy {
  baseURL = `https://${apiConfig.DOMAIN_URL}/api/tools/web/html/v8?url=https://anoboy.show`;
  request = url => {
    return new Promise(async (resolve, reject) => {
      try {
...
class Otakudesu {
  constructor() {
    this.baseurl = `https://${apiConfig.DOMAIN_URL}/api/tools/web/html/v8?url=https://otakudesu.lol`;
  }
  latest = () => {
    return new Promise(async (resolve, reject) => {
      const {
...
class Kiryuu {
  search = async query => {
    return new Promise((resolve, reject) => {
      axios.request({
        url: `https://${apiConfig.DOMAIN_URL}/api/tools/web/html/v8?url=https://kiryuu.id/?s=` + encodeURIComponent(query),
        method: "GET",
        headers: {
...
class MangaToon {
  search = async query => {
    return new Promise((resolve, reject) => {
      axios.request({
        baseURL: `https://${apiConfig.DOMAIN_URL}/api/tools/web/html/v8?url=https://mangatoon.mobi`,
...
class Kusonime {
  search = async query => {
    return new Promise((resolve, reject) => {
      axios.request({
        url: `https://${apiConfig.DOMAIN_URL}/api/tools/web/html/v8?url=https://kusonime.com/?s=` + query,
        method: "GET",
        headers: {
          "user-agent": "Mozilla/5.0 (Linux; Android 10; RMX2020) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/93.0.4577.82 Mobile Safari/537.36"
        }
...
class Komiku {
  constructor() {
    this.baseURL = `https://${apiConfig.DOMAIN_URL}/api/tools/web/html/v8?url=https://komiku.id`,
      this.dataBaseURL = `https://${apiConfig.DOMAIN_URL}/api/tools/web/html/v8?url=https://data.komiku.id`;
  }
  latest = () => {
    return new Promise(async (resolve, reject) => {
      const {
...
class AnimeBatch {
  search = query => {
    return new Promise(async (resolve, reject) => {
      const {
        data
      } = await axios.get(`https://${apiConfig.DOMAIN_URL}/api/tools/web/html/v8?url=https://www.animebatch.id/?s=` + query);
      const $ = cheerio.load(data),
        result = [];
      $("article").each((a, b) => {
        result.push({
...
class DoujinDesu {
  constructor() {
    this.baseURL = `https://${apiConfig.DOMAIN_URL}/api/tools/web/html/v8?url=https://doujindesu.tv`;
  }
  fetchURL = url => {
    return new Promise(async (resolve, reject) => {
      const {
...
class Nekopoi {
  latest = () => {
    return new Promise(async (resolve, reject) => {
      const {
        data
      } = await axios.get(`https://${apiConfig.DOMAIN_URL}/api/tools/web/html/v8?url=https://nekopoi.care`, {
        headers: {
          "User-Agent": "Site24x7",
          "Cache-Control": "no-cache",
          Accept: "*/*",
  ...
  search = (query, page = 1) => {
    return new Promise(async (resolve, reject) => {
      ...
      const {
        data
      } = await axios.get(`https://${apiConfig.DOMAIN_URL}/api/tools/web/html/v8?url=https://nekopoi.care/search/${query}/page/${page}`, {
        headers: {
          "User-Agent": "Site24x7",
          "Cache-Control": "no-cache",
          Accept: "*/*",
...
class Nhentai {
  constructor() {
    this.baseURL = `https://${apiConfig.DOMAIN_URL}/api/tools/web/html/v8?url=https://nhentai.to`;
  }
  latest = () => {
    return new Promise(async (resolve, reject) => {
      await axios.request({
...
class Komikcast {
  latest = () => {
    return new Promise(async (resolve, reject) => {
      const response = await axios.get(`https://${apiConfig.DOMAIN_URL}/api/tools/web/html/v8?url=https://komikcast.lol/daftar-komik/?orderby=update`);
      const $ = cheerio.load(response.data);
      const result = [];
  ...
  search = query => {
    return new Promise(async (resolve, reject) => {
      const response = await axios.get(`https://${apiConfig.DOMAIN_URL}/api/tools/web/html/v8?url=https://komikcast.lol/?s=` + query);
      const $ = cheerio.load(response.data);
      const result = [];
      $(".list-update_item").each((index, element) => {
        const link = $(element).find("a").attr("href");
...
class Oploverz {
  constructor() {
    this.baseURL = `https://${apiConfig.DOMAIN_URL}/api/tools/web/html/v8?url=https://oploverz.life`;
  }
  latest = (page = 1) => {
    return new Promise(async (resolve, reject) => {
      try {
