...
class TrackingPaket {
  constructor() {
    this.cek_url = "https://trackingpaket.com/cek-resi-xhr.php?__amp_source_origin=https%3A%2F%2Ftrackingpaket.com";
    this.list_url = "https://trackingpaket-com.cdn.ampproject.org/v/s/trackingpaket.com/cek-resi-jt-express/?amp_js_v=0.1&usqp=mq331AQIUAKwASCAAgM%3D";
    this.headers = {
      accept: "application/json",
      "accept-language": "id-ID,id;q=0.9",
      "content-type": "multipart/form-data",
      origin: "https://trackingpaket-com.cdn.ampproject.org",
      priority: "u=1, i",
      referer: "https://trackingpaket-com.cdn.ampproject.org/v/s/trackingpaket.com/cek-resi-jt-express/?amp_js_v=0.1&usqp=mq331AQIUAKwASCAAgM%3D",
...
export default async function handler(req, res) {
  ...
  const tracker = new TrackingPaket();
  try {
    let data;
    switch (action) {
      case "check":
